...
Route::screen('orders', OrderListScreen::class)
    ->name('platform.services.orders')
    ->breadcrumbs(fn(Trail $trail) => $trail
        ->parent('platform.index')
        ->push(__('admin.orders'), route('platform.services.orders')));

// Platform > Orders > Order
Route::screen('orders/{order}/edit', OrderEditScreen::class)
    ->name('platform.services.orders.edit')
    ->breadcrumbs(fn(Trail $trail, $order) => $trail
        ->parent('platform.index')
        ->push(__('admin.orders'), route('platform.services.orders.edit', $order)));
